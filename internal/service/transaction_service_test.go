...
func Test_transactionService_Transfer(t *testing.T) {
	...
	t.Run("test success count transaction", func(t *testing.T) {
		...
		transactionRepository.Mock.On("Save", &model.Transaction{UserID: 2, DestinationID: 1, Amount: 500000, Description: "buy something", Category: "Receive Money"}).
			Return(&model.Transaction{ID: 1, UserID: 2, DestinationID: 1, Amount: 500000, Description: "buy something", Category: "Receive Money"}, nil).Once()
		transactionRepository.Mock.On("Save", &model.Transaction{UserID: 1, DestinationID: 2, Amount: 500000, Description: "buy something", Category: "Send Money"}).
			Return(&model.Transaction{ID: 2, UserID: 1, DestinationID: 2, Amount: 500000, Description: "buy something", Category: "Send Money"}, nil).Once()
		...
		input.Amount = 500000
		input.Description = "buy something"
		...
		assert.Equal(t, "buy something", transactions.Description)
	})
}
